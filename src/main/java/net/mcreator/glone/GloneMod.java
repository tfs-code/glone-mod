...
@Mod("glone")
public class GloneMod {
	public static final Logger LOGGER = LogManager.getLogger(GloneMod.class);
	public static final String MODID = "glone";

	public GloneMod(FMLJavaModLoadingContext context) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = context.getModEventBus();

		GloneModItems.REGISTRY.register(bus);

		GloneModMenus.REGISTRY.register(bus);
