...
import net.mcreator.glone.procedures.TeleportOnKeyPressedProcedure;
...
public class TeleportMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		GloneMod.addNetworkMessage(TeleportMessage.class, TeleportMessage::buffer, TeleportMessage::new, TeleportMessage::handler);
	}
}